...
export const Home = () => {
  return (
    <div className="flex w-full h-screen bg-gray-50 flex-col ">
      <div className="w-full h-1/6 realtive flex box-border">
        ...
        <div className="absolute h-1/6 flex right-10 items-center ">
			<PersonFilterButtons />
        </div>
      </div>
      <div className="w-full h-auto flex">
        ...
        <div className="flex gap-10 w-full items-start px-5">
